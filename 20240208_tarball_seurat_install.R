# Tyler 
#LIBRARY PATH
libs <- .libPaths("/home/ttm3567/63_tylert/Analysis_Algorithms/seurat_234_again_Renv/")
# Set CRAN mirror
...
#install.packages("/home/ttm3567/63_tylert/Analysis_Algorithms/Seurat_2.3.4.tar", repos = NULL, type = "source")
