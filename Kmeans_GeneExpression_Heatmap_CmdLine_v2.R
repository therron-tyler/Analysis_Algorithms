...
# by sample - 6 clusters
set.seed(40)
kmeans_gene_normalized_FPKM_HQsamples_6clusters <- kmeans(normalized_FPKM_HQsamples_GoI, centers = 6,iter.max = 10, nstart = 200)
# by sample - 8 clusters
kmeans_gene_normalized_FPKM_HQsamples_8clusters <- kmeans(normalized_FPKM_HQsamples_GoI, centers = 8,iter.max = 10, nstart = 200)

# annotation 6 clusters
my_gene_col_6clusters <- data.frame(Cluster = ifelse(test = kmeans_gene_normalized_FPKM_HQsamples_6clusters$cluster == 1,
                                                     yes = "Gene Cluster 1",
                                                     no = ifelse(test = kmeans_gene_normalized_FPKM_HQsamples_6clusters$cluster == 2,
                                                                 yes = "Gene Cluster 2",
                                                                 no = ifelse(test = kmeans_gene_normalized_FPKM_HQsamples_6clusters$cluster == 3,
                                                                             yes = "Gene Cluster 3",
                                                                             no = ifelse(test = kmeans_gene_normalized_FPKM_HQsamples_6clusters$cluster == 4,
                                                                                         yes = "Gene Cluster 4",
                                                                                         no = ifelse(test = kmeans_gene_normalized_FPKM_HQsamples_6clusters$cluster == 5,
                                                                                                     yes = "Gene Cluster 5",
                                                                                                     no = "Gene Cluster 6"))))))
...
# 8 clusters
my_gene_col_8clusters <- data.frame(Cluster = ifelse(test = kmeans_gene_normalized_FPKM_HQsamples_8clusters$cluster == 1,
                                                     yes = "Gene Cluster 1",
                                                     no = ifelse(test = kmeans_gene_normalized_FPKM_HQsamples_8clusters$cluster == 2,
                                                                 yes = "Gene Cluster 2",
                                                                 no = ifelse(test = kmeans_gene_normalized_FPKM_HQsamples_8clusters$cluster == 3,
                                                                             yes = "Gene Cluster 3",
                                                                             no = ifelse(test = kmeans_gene_normalized_FPKM_HQsamples_8clusters$cluster == 4,
                                                                                         yes = "Gene Cluster 4",
                                                                                         no = ifelse(test = kmeans_gene_normalized_FPKM_HQsamples_8clusters$cluster == 5,
                                                                                                     yes = "Gene Cluster 5",
                                                                                                     no = ifelse(test = kmeans_gene_normalized_FPKM_HQsamples_8clusters$cluster == 6,
                                                                                                                 yes = "Gene Cluster 6",
                                                                                                                 no = ifelse(test = kmeans_gene_normalized_FPKM_HQsamples_8clusters$cluster == 7,
                                                                                                                             yes = "Gene Cluster 7",
                                                                                                                             no = "Gene Cluster 8"))))))))
...
write.csv(my_gene_col_6clusters, 
          file = paste0(output_directory, "6_Gene_Clusters_Sample_Kmeans_",model_name, ".csv"), 
          row.names = TRUE)

write.csv(my_gene_col_8clusters, 
          file = paste0(output_directory, "8_Gene_Clusters_Sample_Kmeans_",model_name, ".csv"), 
          row.names = TRUE)
...
my_gene_col_6clusters_df <- data.frame(Cluster = my_gene_col_6clusters$Cluster)
# assign appropriate row names
rownames(my_gene_col_6clusters_df) <- rownames(my_gene_col_6clusters)

# HEATMAP 1 - clustered samples, columns should remain in specified order
annots_HM_FPKM_HQsamples_6clusters <- pheatmap(normalized_FPKM_HQsamples_GoI, annotation_row = my_gene_col_6clusters_df, cluster_cols = FALSE, cutree_rows = 6, fontsize_row = .5, main = paste0("K-means Gene Expression Matrix (6 clusters) - ",model_name), treeheight_row = 30, angle_col = 315, fontsize_col = 7, width = 10, height = 12, gaps_col = gaps_indices)
ggsave(filename = paste0(output_directory,"6_Clusters_kmeans_Sample_Gene_Expression_Matrix_",model_name,".pdf"),plot = annots_HM_FPKM_HQsamples_6clusters, width = 10, height = 12)

# convert to data frame
my_gene_col_8clusters_df <- data.frame(Cluster = my_gene_col_8clusters$Cluster)
# assign appropriate row names
rownames(my_gene_col_8clusters_df) <- rownames(my_gene_col_8clusters)


annots_HM_FPKM_HQsamples_8clusters <- pheatmap(normalized_FPKM_HQsamples_GoI, annotation_row = my_gene_col_8clusters_df, cluster_cols = FALSE, cutree_rows = 8, fontsize_row = .5, main = paste0("K-means Gene Expression Matrix (8 clusters) - ",model_name), treeheight_row = 30, angle_col = 315, fontsize_col = 7, width = 10, height = 12, gaps_col = gaps_indices)
ggsave(filename = paste0(output_directory,"8_Clusters_kmeans_Sample_Gene_Expression_Matrix_",model_name,".pdf"),plot = annots_HM_FPKM_HQsamples_8clusters, width = 10, height = 12)
...
set.seed(40)
kmeans_gene_merged_exp_grps_df_6clusters <- kmeans(merged_exp_grps_df, centers = 6,iter.max = 10, nstart = 200)

# make two types of gene expression output, one with 6 clusters and one with 8 clusters

merged_exp_grps_gene_col_6clusters <- data.frame(Cluster = ifelse(test = kmeans_gene_merged_exp_grps_df_6clusters$cluster == 1,
                                                                  yes = "Gene Cluster 1",
                                                                  no = ifelse(test = kmeans_gene_merged_exp_grps_df_6clusters$cluster == 2,
                                                                              yes = "Gene Cluster 2",
                                                                              no = ifelse(test = kmeans_gene_merged_exp_grps_df_6clusters$cluster == 3,
                                                                                          yes = "Gene Cluster 3",
                                                                                          no = ifelse(test = kmeans_gene_merged_exp_grps_df_6clusters$cluster == 4,
                                                                                                      yes = "Gene Cluster 4",
                                                                                                      no = ifelse(test = kmeans_gene_merged_exp_grps_df_6clusters$cluster == 5,
                                                                                                                  yes = "Gene Cluster 5",
                                                                                                                  no = "Gene Cluster 6"))))))


# convert to data frame
merged_exp_grps_gene_col_6clusters_df <- data.frame(Cluster = merged_exp_grps_gene_col_6clusters$Cluster)
# assign appropriate row names
rownames(merged_exp_grps_gene_col_6clusters_df) <- rownames(merged_exp_grps_gene_col_6clusters)

# 8 clusters
kmeans_gene_merged_exp_grps_df_8clusters <- kmeans(merged_exp_grps_df, centers = 8,iter.max = 10, nstart = 200)


# Create a dataframe for 8 clusters based on the k-means clustering results, then use as annotations for the Exp Grps Heatmap

merged_exp_grps_gene_col_8clusters <- data.frame(Cluster = ifelse(test = kmeans_gene_merged_exp_grps_df_8clusters$cluster == 1,
                                                                  yes = "Gene Cluster 1",
                                                                  no = ifelse(test = kmeans_gene_merged_exp_grps_df_8clusters$cluster == 2,
                                                                              yes = "Gene Cluster 2",
                                                                              no = ifelse(test = kmeans_gene_merged_exp_grps_df_8clusters$cluster == 3,
                                                                                          yes = "Gene Cluster 3",
                                                                                          no = ifelse(test = kmeans_gene_merged_exp_grps_df_8clusters$cluster == 4,
                                                                                                      yes = "Gene Cluster 4",
                                                                                                      no = ifelse(test = kmeans_gene_merged_exp_grps_df_8clusters$cluster == 5,
                                                                                                                  yes = "Gene Cluster 5",
                                                                                                                  no = ifelse(test = kmeans_gene_merged_exp_grps_df_8clusters$cluster == 6,
                                                                                                                              yes = "Gene Cluster 6",
                                                                                                                              no = ifelse(test = kmeans_gene_merged_exp_grps_df_8clusters$cluster == 7,
                                                                                                                                          yes = "Gene Cluster 7",
                                                                                                                                          no = "Gene Cluster 8")))))))) 

# convert to data frame
merged_exp_grps_gene_col_8clusters_df <- data.frame(Cluster = merged_exp_grps_gene_col_8clusters$Cluster)
# assign appropriate row names
rownames(merged_exp_grps_gene_col_8clusters_df) <- rownames(merged_exp_grps_gene_col_8clusters)

# write the labeled clustering results to a CSV for use later on
write.csv(merged_exp_grps_gene_col_6clusters, 
          file = paste0(output_directory,"6_Gene_Clusters_ExpGrps_Kmeans_",model_name, ".csv"), 
          row.names = TRUE)

write.csv(merged_exp_grps_gene_col_8clusters, 
          file = paste0(output_directory,"8_Gene_Clusters_ExpGrps_Kmeans_",model_name, ".csv"), 
          row.names = TRUE)
...
# 6 clusters
ExpGrp_HeatMap_6clusters <- pheatmap(merged_exp_grps_df, annotation_row = merged_exp_grps_gene_col_6clusters_df, cluster_cols = FALSE, cutree_rows = 6, fontsize_row = .5, main = paste0("K-means Group Gene Expression Matrix (6 clusters) - ",model_name), treeheight_row = 30, angle_col = 315, fontsize_col = 7, width = 10, height = 12, gaps_col = gaps_indices2)
ggsave(filename = paste0(output_directory,"6_Clusters_kmeans_Group_Gene_Expression_Matrix_",model_name,".pdf"),plot = ExpGrp_HeatMap_6clusters, width = 8, height = 12)


# 8 clusters
ExpGrp_HeatMap_8clusters <- pheatmap(merged_exp_grps_df, annotation_row = merged_exp_grps_gene_col_8clusters_df, cluster_cols = FALSE, cutree_rows = 8, fontsize_row = .5, main = paste0("K-means Group Gene Expression Matrix (8 clusters) - ",model_name), treeheight_row = 30, angle_col = 315, fontsize_col = 7, width = 10, height = 12, gaps_col = gaps_indices2)
ggsave(filename = paste0(output_directory,"8_Clusters_kmeans_Group_Gene_Expression_Matrix_",model_name,".pdf"),plot = ExpGrp_HeatMap_8clusters, width = 8, height = 12)
